...
func TestPrice_UnmarshalJSON(t *testing.T) {
	...
	assertJSONEq(t, `{"cents":102}`, NewPrice(1, 2))
	assertJSONEq(t, `{"dollars":14,"cents":215}`, NewPrice(16, 15))
	...
	assertJSONEq(t, `12.34`, NewPrice(12, 34))
	assertJSONEq(t, `"0"`, NewPrice(0, 0))
	assertJSONEq(t, `".137"`, NewPrice(0, 14))
	assertJSONEq(t, `"123."`, NewPrice(123, 0))
	assertJSONEq(t, `"10"`, NewPrice(10, 0))
	assertJSONEq(t, `"12.34"`, NewPrice(12, 34))
